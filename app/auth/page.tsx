...
export default function Auth() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black text-gray-200 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="backdrop-blur-sm bg-gray-900/80 shadow-[0_0_25px_10px_rgba(0,0,0,0.3)] rounded-2xl overflow-hidden border border-green-500/30">
          {/* Cyberpunk-style header */}
          <div className="relative h-20 bg-gradient-to-r from-green-900 via-green-500 to-green-900 overflow-hidden">
          ...
          <div className="p-8">
            ...
            {error && (
              <div className="relative mb-6 p-4 bg-red-900/30 rounded-md overflow-hidden">
            ...
            <div className="space-y-5">
              <div className="relative">
                <label className="block mb-2 text-xs font-mono text-green-400">EMAIL_ADDRESS</label>
                <div className="relative">
                  <input
                    type="email"
                    required
                  ...
                  />
                  <div className="absolute top-0 right-0 mt-3 mr-3 w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                </div>
              </div>
              
              <div className="relative">
                <label className="block mb-2 text-xs font-mono text-green-400">PASSWORD</label>
                <div className="relative">
                  <input
                    type="password"
                    required
            ...
            >
              ...
              <div className="absolute inset-0 w-3/4 h-full transform -skew-x-12 bg-green-400/30 group-hover:animate-shine"></div>
            ...
            <div className="mt-6 pt-6 border-t border-green-900/40 flex justify-between items-center">
