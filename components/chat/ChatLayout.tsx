...
export default function ChatLayout() {
  ...
  return (
    <main className="flex h-screen bg-gray-900 text-gray-100">
      {/* Navigation Sidebar */}
<nav className="w-[60px] bg-gray-950 border-r border-gray-800 flex flex-col items-center py-4">
...
{/* Chat List Sidebar */}
<aside className="w-[320px] bg-gray-900 flex flex-col border-r border-gray-800">
  {/* Header */}
  <div className="h-[60px] bg-gray-950 flex items-center px-4 justify-between">
    <span className="text-sm font-medium text-emerald-500">Users</span>
  </div>
        {/* Search */}
      ...
      <div className="flex-1 flex flex-col bg-gray-900">
        ...
        <header className="h-[60px] bg-gray-950 flex items-center px-4 justify-between border-b border-gray-800">
          ...
          <div className="flex items-center gap-2 text-gray-400">
            <Button variant="ghost" size="icon" className="hover:bg-gray-800 hover:text-emerald-500 transition-colors rounded-full h-8 w-8">
        ...
        <div className="flex-1 overflow-y-auto p-4 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent bg-gray-950 bg-opacity-90 bg-[url('/subtle-dark-pattern.png')]">
      ...
      return (
        <div key={msg.id} className={`mt-3 flex ${isCurrentUser ? "justify-end" : "justify-start"}`}>
          ...
          >
            ...
            <p className="text-[10px] text-gray-300 text-right mt-1 opacity-70">
  ...
  <div className="flex items-center gap-2 mb-3">
    ...
    >
      <Send className="h-5 w-5" /> {/* Replaced Mic with Send */}
    </Button>
  </div>
  ...
  <div className="flex items-center gap-2">
    ...
    <Button 
      ...
      className="text-gray-400 hover:text-emerald-500 hover:bg-gray-800 transition-colors rounded-full h-10 w-10"
    >
      <Sparkles className="h-5 w-5" /> {/* Added Sparkles icon */}
    </Button>
    ...
    <Button 
      ...
      className="text-gray-400 hover:text-emerald-500 hover:bg-gray-800 transition-colors rounded-full h-10 w-10"
    >
      <Mic className="h-5 w-5" /> {/* Added Mic icon */}
    </Button>
